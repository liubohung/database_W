...
CREATE TABLE `class_detail` (
  ...
  `Haveto` varchar(2) DEFAULT NULL,
  `College` varchar(8) DEFAULT NULL,
  `Totalnum` int(3) DEFAULT NULL,
  `Nownum` int(3) DEFAULT NULL,
  `Teacher_Name` varchar(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- 傾印資料表的資料 `class_detail`
--

INSERT INTO `class_detail` (`Class`, `Name`, `Code`, `Credit`, `Haveto`, `College`, `Totalnum`, `Nownum`, `Teacher_Name`) VALUES
('班級', '課程名稱', 0, 0, '必選', '開課單位', 0, 0, '授課教師'),
('資訊一甲', '班級活動', 1274, 0, 'M', '資訊工程學系', 72, 68, '王銘宏'),
('資訊一甲', '程式設計(III)', 1276, 2, 'M', '資訊工程學系', 90, 80, '王銘宏'),
('資訊一甲', '程式設計(IV)', 1277, 2, 'M', '資訊工程學系', 90, 88, '王銘宏'),
('資訊一甲', '普通物理-電、磁、光', 1278, 1, 'M', '資訊工程學系', 72, 72, '楊嘉會'),
...
('資訊一乙', '普通物理-電、磁、光', 1288, 1, 'M', '資訊工程學系', 72, 68, '馬仕信'),
...
('資訊一丙', '普通物理-電、磁、光', 1298, 1, 'M', '資訊工程學系', 72, 72, ')林菲'),
...
('資訊二甲', '系統分析與設計', 1310, 3, 'O', '資訊工程學系', 80, 78, '蔡明翰'),
('資訊二甲', '物件導向設計', 1311, 3, 'O', '資訊工程學系', 70, 78, '陳錫民'),
('資訊二甲', '物件導向設計實習', 1312, 1, 'O', '資訊工程學系', 70, 81, '陳錫民'),
('資訊二甲', '資訊與網路安全', 1313, 3, 'O', '資訊工程學系', 75, 81, '劉宗杰'),
('資訊二甲', 'UNIX應用與實務', 1314, 2, 'O', '資訊工程學系', 80, 88, '張哲誠'),
...
('資訊二丙', '系統分析與設計', 1321, 3, 'O', '資訊工程學系', 85, 87, '蔡明翰'),
('資訊二丙', '物件導向設計', 1322, 3, 'O', '資訊工程學系', 80, 80, '陳錫民'),
('資訊二丙', '物件導向設計實習', 1323, 1, 'O', '資訊工程學系', 80, 88, '陳錫民'),
('資訊二丙', '資訊與網路安全', 1324, 3, 'O', '資訊工程學系', 75, 80, '劉宗杰'),
('資訊二丙', 'UNIX應用與實務', 1325, 2, 'O', '資訊工程學系', 60, 71, '張哲誠'),
('資訊二甲', '物件導向設計', 1326, 3, 'O', '資訊工程學系', 75, 65, '蔡國裕'),
('資訊二甲', '物件導向設計實習', 1327, 1, 'O', '資訊工程學系', 60, 46, '蔡國裕'),
('資訊二甲', '組合數學', 1328, 3, 'O', '資訊工程學系', 85, 86, '游景盛'),
('資訊二甲', '電子商務安全', 1329, 3, 'O', '資訊工程學系', 85, 88, '李榮三'),
('資訊二甲', '數位信號處理導論', 1330, 3, 'O', '資訊工程學系', 60, 50, '陳啟鏘'),
...
('資訊碩一', '無線隨意與感測網路技', 1354, 3, 'O', '資訊工程學系', 35, 10, '陳烈武'),
...
('企管一乙', '會計學(二)實習', 2143, 0, 'M', '企業管理學系', 75, 75, '賴家蓁'),
...
('企管一甲', '商業軟體應用(一)', 2148, 3, 'O', '企業管理學系', 60, 71, '王淑娟'),
('企管一甲', '管理與統計', 2149, 3, 'O', '企業管理學系', 60, 35, '黃鼎翔'),
...
('企管二甲', '休閒事業管理', 2162, 3, 'O', '企業管理學系', 60, 52, '黃智彥'),
('企管二甲', '行銷管理個案研究', 2163, 3, 'O', '企業管理學系', 60, 74, '王智弘'),
('企管二甲', '企業電子化', 2164, 3, 'O', '企業管理學系', 60, 58, '張道平'),
('企管二甲', '消費者行為', 2165, 3, 'O', '企業管理學系', 60, 59, '王智弘'),
('企管二甲', '管理心理學', 2166, 3, 'O', '企業管理學系', 60, 69, '何雅利'),
('企管二甲', '應用程式設計', 2167, 3, 'O', '企業管理學系', 45, 44, '駱達彪'),
...
('企管三甲', '人力資源發展', 2176, 3, 'O', '企業管理學系', 60, 59, '黃聰輝'),
('企管三甲', '文化創意經營策略', 2177, 3, 'O', '企業管理學系', 88, 86, '劉平文'),
('企管三甲', '企業資源規劃實務(二', 2178, 3, 'O', '企業管理學系', 60, 16, '莊玉成'),
('企管三甲', '服務科學與創新', 2179, 3, 'O', '企業管理學系', 60, 23, '張秀樺'),
('企管三甲', '投資組合管理', 2180, 3, 'O', '企業管理學系', 60, 39, '蕭國鐘'),
('企管三甲', '作業管理個案研究', 2181, 3, 'O', '企業管理學系', 60, 69, '郭鐘元'),
('企管三甲', '財務管理個案研究', 2182, 3, 'O', '企業管理學系', 60, 61, '廖東亮'),
('企管三甲', '職場英文', 2184, 3, 'O', '企業管理學系', 60, 60, '黃禮林'),
('企管三甲', '產業與競爭分析', 2185, 3, 'O', '企業管理學系', 60, 44, '賴泳龍'),
('企管四甲', '企業管理實務', 2186, 3, 'O', '企業管理學系', 88, 83, '劉平文'),
('企管四甲', '投資管理實務(二)', 2188, 3, 'O', '企業管理學系', 60, 27, '駱達彪'),
('企管四甲', '科技應用與金融服務', 2189, 3, 'O', '企業管理學系', 60, 24, '黃禮林'),
('企管四甲', '流通管理', 2190, 3, 'O', '企業管理學系', 60, 20, '李兆玄'),
('企管四甲', '期貨與選擇權', 2191, 3, 'O', '企業管理學系', 60, 57, '駱達彪'),
('企管四甲', '綠色企業與創業', 2192, 3, 'O', '企業管理學系', 60, 35, '張寶蓉'),
('企管四甲', '職場實務', 2193, 3, 'O', '企業管理學系', 88, 84, '劉平文'),
...
('通識－人文(H)', '希臘羅馬神話故事與西', 2872, 2, 'O', '通識核心課程', 75, 75, '余瓊宜'),
('通識－人文(H)', '希臘羅馬神話故事與西', 2873, 2, 'O', '通識核心課程', 75, 72, '余瓊宜'),
...
('通識－人文(H)', '音樂行旅 - 巡訪古', 2915, 2, 'O', '通識核心課程', 60, 51, '曾韻心'),
...
('通識－自然(N)', '智慧城市無所不在的監', 2939, 2, 'O', '通識核心課程', 60, 57, '蔡明璋'),
...
('通識－社會整合(', '心理劇與自我成長', 2969, 2, 'O', '通識核心課程', 40, 39, '鄒繼礎'),
...
('通識－統合(M)', '培育3D設計夢想號學', 2989, 2, 'O', '通識核心課程', 45, 42, '陳上元'),
('通識－統合(M)', '創業創意營運管理', 2991, 2, 'O', '通識核心課程', 60, 58, '魏彰志'),
('通識－統合(M)', '聲音表達與訓練', 2992, 2, 'O', '通識核心課程', 40, 37, '湛明暉'),
('通識－統合(M)', '智慧生活與大數據物聯', 2993, 2, 'O', '通識核心課程', 40, 38, '簡甫任'),
('通識－統合(M)', '探討在台日商管理之文', 2994, 2, 'O', '通識核心課程', 40, 38, '李豪軒'),
('通識－統合(M)', '鑽石寶石及翡翠玉石之', 2995, 2, 'O', '通識核心課程', 40, 40, '喻家駿'),
...
('通識－統合(M)', '彩色寶石鑑賞與珠寶事', 3010, 2, 'O', '通識核心課程', 40, 40, '李建緯'),
...
('通識－人文(夜)', '台灣文學', 3015, 2, 'O', '通識核心課程', 78, 76, '金尚浩'),
('通識－人文(夜)', '應用文', 3016, 2, 'O', '通識核心課程', 78, 75, '吳秀英'),
('通識－人文(夜)', '批判思考', 3017, 2, 'O', '通識核心課程', 78, 76, '林永崇'),
('通識－人文(夜)', '旅遊與多元學習	', 3018, 2, 'O', '通識核心課程', 40, 25, '薛珍華'),
('通識－人文(夜)', '越南地理與文化', 3019, 2, 'O', '通識核心課程', 70, 69, '黃青雲'),
('通識－自然(夜)', '世界建築欣賞', 3020, 2, 'O', '通識核心課程', 70, 66, '郭錦津'),
('通識－自然(夜)', '生命科學', 3021, 2, 'O', '通識核心課程', 80, 182, '葉怡巖'),
('通識－自然(夜)', '生態環境保育', 3022, 2, 'O', '通識核心課程', 75, 73, '施漢鵬'),
('通識－自然(夜)', '生物學與生物倫理', 3023, 2, 'O', '通識核心課程', 78, 35, '張智翔'),
('通識－自然(夜)', '全球暖化與綠色環境設', 3024, 2, 'O', '通識核心課程', 70, 68, '郭錦津'),
('通識－自然(夜)', '衛星科技應用', 3025, 2, 'O', '通識核心課程', 78, 54, '劉文甦'),
('通識－自然(夜)', '綠能與環境', 3026, 2, 'O', '通識核心課程', 78, 78, '傅俊中'),
('通識－自然(夜)', '生活中的工程與科技', 3027, 2, 'O', '通識核心課程', 60, 59, '許聖富'),
('通識－自然(夜)', '智慧城市與行動應用', 3028, 2, 'O', '通識核心課程', 45, 44, '林哲暉'),
('通識－自然(夜)', '3D城市與數位校園', 3029, 2, 'O', '通識核心課程', 60, 59, '羅文珊'),
('通識－自然(夜)', '氣候變遷對臺灣之衝擊', 3030, 2, 'O', '通識核心課程', 70, 69, '黃志偉'),
('通識－自然(夜)', '食品衛生與安全', 3031, 2, 'O', '通識核心課程', 83, 82, '賴奇厚'),
('通識－社會(夜)', '個人資料保護法', 3032, 2, 'O', '通識核心課程', 78, 76, '劉南英'),
('通識－社會(夜)', '智慧財產之保護與實務', 3033, 2, 'O', '通識核心課程', 78, 77, '余賢東'),
('通識－社會(夜)', '智慧財產之保護與實務', 3034, 2, 'O', '通識核心課程', 78, 73, '蔡宜宏'),
('通識－社會(夜)', '社會學與生活體驗', 3035, 2, 'O', '通識核心課程', 78, 73, '蔡振志'),
('通識－社會(夜)', '社會學與生活體驗', 3036, 2, 'O', '通識核心課程', 78, 75, '蔡振志'),
('通識－社會(夜)', '民法實用', 3037, 2, 'O', '通識核心課程', 78, 76, '蔡宜宏'),
('通識－社會(夜)', '消費者保護法', 3038, 2, 'O', '通識核心課程', 78, 77, '劉南英'),
('通識－社會(夜)', '策略理論與中國崛起', 3039, 2, 'O', '通識核心課程', 78, 77, '白兆偉'),
('通識－社會(夜)', '智慧城市競爭力', 3040, 2, 'O', '通識核心課程', 45, 44, '賴玉真'),
('通識－社會(夜)', '現代韓國社會和文化', 3041, 2, 'O', '通識核心課程', 78, 77, '金尚浩'),
('通識－社會(夜)', '性別平等與親密關係', 3042, 2, 'O', '通識核心課程', 70, 69, '陳如音'),
('通識－社會(夜)', '戀愛、家庭與性別平等', 3043, 2, 'O', '通識核心課程', 70, 60, '陳如音'),
('通識－統合(夜)', '空間資訊與智慧生活', 3045, 2, 'O', '通識核心課程', 60, 58, '吳政庭'),
('通識－統合(夜)', '彩排與公演', 3048, 2, 'O', '通識核心課程', 78, 31, '陳思照'),
('通識－統合(夜)', '3D動畫虛擬實境實作', 3049, 2, 'O', '通識核心課程', 40, 28, '陳淑慧'),
('企管一甲', '全民國防教育軍事訓練', 3767, 0, 'M', '企業管理學系', 120, 111, '賴金燕'),
('資訊二甲', '全民國防教育軍事訓練', 3779, 0, 'M', '資訊工程學系', 120, 112, '王金輝'),
('資訊二乙', '全民國防教育軍事訓練', 3780, 0, 'M', '資訊工程學系', 120, 98, '余君青'),
('通識－自然(N)', '英文科學導讀(二)', 3808, 2, 'O', '通識核心課程', 70, 56, '羅珮瑄'),
('通識－社會(S)', '前瞻時尚與潮流', 3809, 2, 'O', '通識核心課程', 70, 65, '陳柏全'),
('通識－統合(M)', '逢甲夜市雙語導覽設計', 3810, 2, 'O', '通識核心課程', 60, 43, '陳秋華'),
('通識－統合(夜)', '讀劇表演', 3811, 2, 'O', '通識核心課程', 40, 27, '徐培晃'),
('通識－統合(夜)', '音樂劇演唱技巧', 3812, 2, 'O', '通識核心課程', 60, 17, '陳思照'),
('通識－統合(M)', '劇場與影像設計', 3813, 2, 'O', '通識核心課程', 40, 23, '蘇曉青'),
('通識－統合(M)', 'Android Ap', 3815, 2, 'O', '通識核心課程', 40, 36, '洪耀正'),
('通識－統合(M)', 'Android Ap', 3816, 2, 'O', '通識核心課程', 40, 36, '林嘉成'),
('通識－統合(M)', 'iOS APP程式設', 3817, 2, 'O', '通識核心課程', 48, 48, '管志偉'),
('通識－統合(M)', 'iOS APP程式設', 3818, 2, 'O', '通識核心課程', 40, 34, '陳重宏'),
('通識－統合(M)', '體育玩很大：創意運動', 3820, 2, 'O', '通識核心課程', 40, 38, '王亭文'),
('通識－統合(M)', 'Android Ap', 3827, 2, 'O', '通識核心課程', 40, 37, '陳伯維'),
('通識－統合(M)', 'Android Ap', 3828, 2, 'O', '通識核心課程', 40, 27, '陳伯維'),
('通識－統合(M)', 'Android Ap', 3829, 2, 'O', '通識核心課程', 40, 31, '陳伯維'),
('通識－統合(M)', '春雨講堂-生活的奧義', 3889, 2, 'O', '通識核心課程', 100, 101, '何寄澎'),
('通識－統合(M)', '使用者導向設計', 3891, 2, 'O', '通識核心課程', 20, 16, '月妹)'),
('通識－統合(M)', '打造自我品牌─職能加', 3892, 2, 'O', '通識核心課程', 45, 44, '陳淑慧'),
('通識－統合(M)', '與產業接軌─共通核心', 3893, 2, 'O', '通識核心課程', 45, 42, '陳淑慧'),
